...
for sample_id=1:sample_total
    ...
    q=0.253; %probability an exposed person is tracible
%     q=0;
...
%JRS
CI_IH_total_bounds_matrix_1=zeros(2,CI_num);
...
for i=1:CI_num
    ...
    CI_IH_total_bounds_matrix_1(:,i)=[prctile(total_data_temp,5),prctile(total_data_temp,95)]';
...
plot(0:54,a(55:-1:1),'linewidth',2,'color','b');
...
plot(0:54,a,'linewidth',2,'color','r')
...
hold on;
plot(T_CI_vector,CI_IH_total_bounds_matrix_1(1,:),'--','color','b');
hold on 
plot(T_CI_vector,mu,'*','color','b');
hold on
plot(T_CI_vector,CI_IH_total_bounds_matrix_1(2,:),'+','color','b');
hold on;
...
sum(CI_IH_total_matrix(:,239)-CI_IH_total_matrix(:,120)>10)
sum(CI_IH_total_matrix(:,239)-CI_IH_total_matrix(:,120)>20)
sum(CI_IH_total_matrix(:,239)-CI_IH_total_matrix(:,120)>30)
sum(CI_IH_total_matrix(:,239)-CI_IH_total_matrix(:,120)>50)
sum(CI_IH_total_matrix(:,239)-CI_IH_total_matrix(:,120)>100)

...
for sample_id=1:sample_total
    ...
    N=57370000; %total population
    
    theta=0.467; %factor for lambda_E=lambda_A=lambda_N*theta;
    lambda_N=0.4925;%infection rate of IN
    ...
    q=0.736; %probability an exposed person is tracible
%     q=0;
    ...
    c=0.2625;
    %c_1=1.1;
    gamma_IH=0.0535*c;%recovery rate of IHL NOT estimated!
   ...
   % S_t=N-150-75-32; %susceptible
    ...
    a=0.1254; %strength of control: all lambda's reduced to lambda*a

...
for sample_id=1:sample_total
    ...
    q=0.2; %probability an exposed person is tracible
%     q=0;
...
legend('recaled histogram of ending time', 'fitted ending time distribution',...
    ...
    ['end time CI lower bound=' num2str(T_end_mu-2*T_end_sigma) ', p=' num2str(p_ci)],'Location','Northeast','FontSize',15,'LineWidth',1.5);% title(legend_temp{16},'FontSize',20)

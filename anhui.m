...
for sample_id=1:sample_total
    ...
    N=63659000; %total population
    
    lambda_N=0.679;%infection rate of IN
    ...
    q=0.103; %probability an exposed person is tracible
%     q=0;
    ...
    c=0.249;
    %c_1=1.1;
    gamma_IH=0.079*c;%recovery rate of IHL NOT estimated!    
    ...
    a=0.0116; %strength of control: all lambda's reduced to lambda*a

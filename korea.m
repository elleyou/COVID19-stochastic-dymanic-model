...
for sample_id=1:sample_total
    ...
    N=51640000; %total population
    
    lambda_N=0.7;%infection rate of IN
    theta=0.48; %factor for lambda_E=lambda_A=lambda_N*theta;
    lambda_E=lambda_N*theta; %infection rate of the E, same as A
    lambda_A=lambda_N*theta; %infection rate of the A, same as E

    rho=0.71; %probabiity an exposed person will grow symptom (go to A or E)
%     q=0.3811; %probability an exposed person is tracible
    q=0.7771;
    ...
    c=0.5347;
    %c_1=1.1;
    gamma_IH=0*c;%recovery rate of IHL NOT estimated!
...
%     d = 2.42;
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    T_control1=7;
    T_control=10; %when control measrues are implemented
    a=0.038; %strength of control: all lambda's reduced to lambda*a
 ...
 while t_temp<T_control
    ...
    lambda_E=lambda_N*theta; %infection rate of the E, same as A
    lambda_A=lambda_N*theta; %infection rate of the A, same as E
    %mean quarantine time reduce by b days
    %mean hospitalization time reduce by b days
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
plot(25:42,a,'linewidth',2,'color','r');
...
legend(legend_temp{1},legend_temp{2},legend_temp{3},legend_temp{4},legend_temp{8},legend_temp{9}, 'Location','Northwest','FontSize',15,'LineWidth',1.5)
...
title(legend_temp{17},'FontSize',25)
...
active_two_week_ago=mean(active_number(15:42));
active_two_week_later=mean(active_number(43:70));

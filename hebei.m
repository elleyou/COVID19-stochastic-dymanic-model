...
for sample_id=1:sample_total
    ...
    N=75919700; %total population
    
    lambda_N=0.4514;%infection rate of IN
    ...
    q=0.077; %probability an exposed person is tracible
%     q=0;
    ...
    c=0.338;
    %c_1=1.1;
    gamma_IH=0.084*c;%recovery rate of IHL NOT estimated!    
    ...
    a=0.068; %strength of control: all lambda's reduced to lambda*a

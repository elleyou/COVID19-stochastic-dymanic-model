...
for sample_id=1:sample_total
    ...
    N=80700000; %total population
    
    lambda_N=0.508;%infection rate of IN
    ...
    q=0.157; %probability an exposed person is tracible
%     q=0;
    ...
    c=0.29;
    %c_1=1.1;
    gamma_IH=0.102*c;%recovery rate of IHL NOT estimated!    
    ...
    a=0.035; %strength of control: all lambda's reduced to lambda*a
...
plot(0:30,a,'linewidth',2,'color','b');
...
% title(legend_temp{16},'FontSize',20)
% legend(legend_temp{1},legend_temp{2},legend_temp{3},legend_temp{4},legend_temp{5},legend_temp{6},legend_temp{7},legend_temp{8}, 'Location','Northwest','FontSize',11,'LineWidth',1.5)
title('Jiangsu','FontSize',25)
